...
class Smsglobal_Subscription_Widget extends WP_Widget {
	...
	function form( $instance ) {
		if ( $instance ) {
			...
			$form_title = __( 'SMS Subscription' );
            $name_label = __( 'Name' );
            $mobile_label = __( 'Mobile' );
...
?>
    ...
    <p>
        <label for="<?php echo $this->get_field_id( 'form_title' ); ?>"><?php _e( 'Subscription Form Title:' ); ?></label>
    ...
    <p>
        <label for="<?php echo $this->get_field_id( 'mobile_label' ); ?>"><?php _e( 'Mobile Label:' ); ?></label>
    ...
    <p>
        <label for="<?php echo $this->get_field_id( 'url_label' ); ?>"><?php _e( 'URL Label:' ); ?></label>
    ...
    <p>
        <label for="<?php echo $this->get_field_id( 'submit_text' ); ?>"><?php _e( 'Submit Text:' ); ?></label>
...
function gCF_add_javascript_files()
{
    if (!is_admin())
    {
        ...
        wp_enqueue_script( 'smsglobal', get_option('siteurl').'/wp-content/plugins/smsglobal/assets/smsglobal.js');
    }
}
