 ...
 */
class Smsglobal_RestApiClient_Http_Request_Curl implements Smsglobal_RestApiClient_Http_Request_Adapter
{
    /**
    ...
    public function request($url, $method = 'GET', array $headers = array(), $content = null)
    {
        ...
        return new Smsglobal_RestApiClient_Http_Response_Curl($handle);
    }
}