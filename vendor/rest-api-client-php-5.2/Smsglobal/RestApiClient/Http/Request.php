 ...
 */
class Smsglobal_RestApiClient_Http_Request
{
    ...
    public function __construct($url = null, $adapter = self::DEFAULT_ADAPTER)
    {
        ...
        $this->headers = new Smsglobal_RestApiClient_Http_HeaderBag();
    }
    /**
    ...
    public function makeRequest($body = null)
    {
        ...
        $adapter = new ${'_value_52141bc3e1f37' . !($_value_52141bc3e1f37 = is_string(($_value_52141bc3e1ecd = $this->adapter)) ? str_replace('\\', '_', $_value_52141bc3e1ecd) : $_value_52141bc3e1ecd)}();
        ...
        $response = $adapter->request($this->url, $this->method, $headers, $body);
        return $response;
    }
    /**
    ...
    public function get()
    {
        return $this->setMethod(__FUNCTION__)->makeRequest();
    }
    /**
    ...
    {
        return $this->setMethod(__FUNCTION__)->makeRequest($data);
    }
    /**
