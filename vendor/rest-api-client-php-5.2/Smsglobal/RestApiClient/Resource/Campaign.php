 ...
 */
class Smsglobal_RestApiClient_Resource_Campaign extends Smsglobal_RestApiClient_Resource_Base
{
    /**
     * Group
     * @var Group
    ...
    {
        if (!$group instanceof Smsglobal_RestApiClient_Resource_Group) {
            $group = (int) $group;
        }
        $this->group = $group;
        return $this;
