 ...
 */
class Smsglobal_RestApiClient_Resource_Sms extends Smsglobal_RestApiClient_Resource_Base
{
    /**
     * Origin
     * @var string
    ...
    {
        if (null !== $campaign && !$campaign instanceof Smsglobal_RestApiClient_Resource_Campaign) {
    ...
    public function setSharedPool($sharedPool)
    {
        if (null !== $sharedPool) {
            $this->origin = null;
            if (!$sharedPool instanceof Smsglobal_RestApiClient_Resource_SharedPool) {
     ...
     * @return $this Provides a fluent interface
     */
    public function send(Smsglobal_RestApiClient_RestApiClient $rest)
    {
        $this->id = null;
