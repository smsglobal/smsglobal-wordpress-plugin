<?php
class Smsglobal_RestApiClient_Http_HeaderBagTest extends PHPUnit_Framework_TestCase
{
    /**
    ...
    {
        $bag = new Smsglobal_RestApiClient_Http_HeaderBag();
    ...
    {
        $bag = new Smsglobal_RestApiClient_Http_HeaderBag(array('foo' => 'Tue, 4 Sep 2012 20:00:00 +0200'));
    ...
    {
        $bag = new Smsglobal_RestApiClient_Http_HeaderBag(array('foo' => 'Tue'));
        $headerDate = $bag->getDate('foo');
    }
    ...
    {
        $bag = new Smsglobal_RestApiClient_Http_HeaderBag(array('foo' => 'bar', 'fuzz' => 'bizz'));
    ...
    {
        $bag = new Smsglobal_RestApiClient_Http_HeaderBag(array('cache-control' => 'public, max-age=10'));
        $this->assertTrue($bag->hasCacheControlDirective('public'));
        $this->assertTrue($bag->getCacheControlDirective('public'));
        $this->assertTrue($bag->hasCacheControlDirective('max-age'));
        $this->assertEquals(10, $bag->getCacheControlDirective('max-age'));
    ...
    {
        $bag = new Smsglobal_RestApiClient_Http_HeaderBag(array('cache-control' => 'max-age="0"'));
        $this->assertTrue($bag->hasCacheControlDirective('max-age'));
        $this->assertEquals(0, $bag->getCacheControlDirective('max-age'));
    }
    public function testCacheControlDirectiveOverrideWithReplace()
    {
        $bag = new Smsglobal_RestApiClient_Http_HeaderBag(array('cache-control' => 'private, max-age=100'));
    ...
    public function testGetIterator()
    {
        ...
        $headerBag = new Smsglobal_RestApiClient_Http_HeaderBag($headers);
        $i = 0;
